...
const FooterBussines = () => {
  return (
    <>
    <footer class="bg-white dark:bg-blue-700">
    <div class="container px-6 py-12 mx-auto">
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
            <div class="sm:col-span-2">
                <h1 class="max-w-lg text-3xl font-semibold tracking-tight text-gray-800 xl:text-4xl dark:text-white">Subscribe our newsletter to get update.</h1>

                <div class="flex flex-col mx-auto mt-8 space-y-3 md:space-y-0 md:flex-row">
