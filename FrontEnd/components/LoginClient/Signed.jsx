  ...
  return (
    <div className="flex justify-center flex-col items-center py-20 font-cool_p text-4xl my-auto ">
        ...
        </Link>
        {
          session.role === 3?
        <Link href="/admin">
        <button className=" m-4 overflow-hidden px-6 py-2 font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-600 rounded-lg hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80">Admin</button>
        </Link>
        :
        null
        }
