  ...
  return (
    <>
      ...
      <div className="h-screen">
        <div className="flex flex-col items-center mt-28 text-gray-900">
          <div className="">
            <p
              data-aos="fade-up"
              className="mb-4 text-4xl tracking-tight font-extrabold leading-tight text-gray-900 dark:text-gray-900"
            >
              Escríbenos!
            </p>
          </div>
          ...
          <form data-aos="fade-up" onSubmit={sendEmail} className="w-80">
            ...
            <div class="mb-6">
              ...
              <input
                type="mail"
                placeholder="email"
                className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-900 dark:focus:ring-blue-500 dark:focus:border-blue-500"
                name="user_email"
                required
              />
            </div>
